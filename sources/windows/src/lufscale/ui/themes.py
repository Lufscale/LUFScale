...
QFrame#panel[role="sources"] {
    /* Match Settings: the source box must keep a visible neutral lower edge
       instead of inheriting the near-black bevel used by generic panels. */
