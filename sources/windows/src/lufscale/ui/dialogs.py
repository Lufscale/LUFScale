...
def choose_localized_csv_path(
    ...
    """Choose a CSV path in a fully application-localized dialog."""
...
class ApplicationInfoDialog(QDialog):
    def __init__(
        ...
        # final line in French and several fallback-font scripts.
        text_view = QTextEdit()
        ...
        # the native Qt build as well as on the packaged fallback fonts.
        ...
        # viewport. This absorbs native scrollbar metrics and Cyrillic,
        ...
        # fallback fonts (notably Cyrillic, CJK and Devanagari) can
        ...
        # made the last Russian lines unreachable on some systems.
        text_view.setVerticalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAsNeeded
        )
...
class CompletionSummaryDialog(QDialog):
    ...
    def __init__(
        ...
        # Keep two full typographic lines as a safety margin. Native
