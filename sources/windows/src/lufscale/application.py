...
class MainWindow(QMainWindow):
    ...
    def _restore_source_safety_status(self, message: str) -> None:
        """Restore the permanent safety notice after a timed message ends."""
        if not message:
    ...
    def _retranslate_ui(self) -> None:
        ...
        self.open_output_button.setText(self.t("open_folder"))
    ...
    def _refresh_issue_buttons(self) -> None:
        ...
        for category, button, text_key, accessibility_key in (
            ...
            # These counters behave like the other direct-action buttons:
            # keep the detailed text for assistive technologies without
            # displaying it as a hover tooltip.
            button.setToolTip("")
